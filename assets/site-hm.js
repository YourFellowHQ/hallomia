...
})(window,document,'script','dataLayer','GTM-MNL39P7S');</script>
...
(function(){
  ...
  var navHTML = ''
    ...
    +   '</nav>'
    +   '<div class="nav-r">'
    +     '<a class="ghost" href="'+R+'aanmelden/">Inloggen</a>'
  ...
  var footHTML = ''
    ...
    +     '<div class="about">'
    +       BRAND
    +       '<p>Hallo Mia regelt je marketing. Jij regelt je bedrijf. Een AI-collega die je bedrijf kent en met je meedenkt.</p>'
    +       '<div class="award">Gemaakt door YourFellow, performance marketing uit Zevenbergen<br>Dutch Search Award 2025</div>'
    +     '</div>'
    ...
    +       '<a href="'+R+'uitleg/">Uitleg &amp; tutorials</a>'
